...
export default PaymentScreen = () => {
  ...
  const [cards, setCards] = useState([
    ...
    },
    {
      ...
      holder: "Sofia Chen",
      expiration: "12/24",
      logo: "https://img.icons8.com/color/70/000000/mercado-pago.png",
    },
  ]);
  ...
  const updateCardDetails = () => {
    ...
    const newCard = {
      ...
      logo:
        cardNetwork === "Visa"
          ? "https://img.icons8.com/color/70/000000/visa.png"
          : cardNetwork === "Mastercard"
          ? "https://img.icons8.com/color/70/000000/mastercard.png"
          : "https://img.icons8.com/color/70/000000/mercado-pago.png",
    };
  ...
  return (
    ...
    >
            ...
            <View key={card.id} style={paymentStyles.cardContainer}>
              ...
              <View style={paymentStyles.cardInfoContainer}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={paymentStyles.cardInfoValue}>
                    {card.expiration}
                  </Text>
                </View>
              </View>
      ...
      <View
        style={[cartStyles.containerTotal, { marginTop: 10, marginBottom: 10 }]}
      >
        <View style={[{ width: 70 }]}>
          <CustomButton
        ...
        <View style={[{ width: 200 }]}>
          <CustomButton ButtonPress={buttonAlert} btnText={"Confirm payment"} />
        </View>
      </View>
    </View>
  );
